...
<div id="servername">
<h1><?php print_r($ARK1Info ['HostName'])?></h1>
...
<div id="servertable">
				<table>
					...
					<tbody>
	<?php if( !empty( $ARK1Players ) ): ?>
	<?php foreach( $ARK1Players as $ARK1Player ): ?>
						<tr>
							<td><?php echo htmlspecialchars( $ARK1Player[ 'Name' ] ); ?></td>
							<td><?php echo $ARK1Player[ 'Frags' ]; ?></td>
							<td><?php echo $ARK1Player[ 'TimeF' ]; ?></td>
						</tr>
	<?php endforeach; ?>
	<?php else: ?>
						<tr>
