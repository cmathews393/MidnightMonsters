...
<div id="servername">
<h1><?php print_r($PZInfo ['HostName'])?></h1>
...
<div id="servertable">
				<table>
					...
					<tbody>
	<?php if( !empty( $PZPlayers ) ): ?>
	<?php foreach( $PZPlayers as $PZPlayer ): ?>
						<tr>
							<td><?php echo htmlspecialchars( $PZPlayer[ 'Name' ] ); ?></td>
							<td><?php echo $PZPlayer[ 'Frags' ]; ?></td>
							<td><?php echo $PZPlayer[ 'TimeF' ]; ?></td>
						</tr>
	<?php endforeach; ?>
	<?php else: ?>
						<tr>
