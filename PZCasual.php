...
<div id="servername">
<h1><?php print_r($PZCasualInfo ['HostName'])?></h1>
...
<div id="servertable">
				<table>
					...
					<tbody>
	<?php if( !empty( $PZCasualPlayers ) ): ?>
	<?php foreach( $PZCasualPlayers as $PZCasualPlayer ): ?>
						<tr>
							<td><?php echo htmlspecialchars( $PZCasualPlayer[ 'Name' ] ); ?></td>
							<td><?php echo $PZCasualPlayer[ 'Frags' ]; ?></td>
							<td><?php echo $PZCasualPlayer[ 'TimeF' ]; ?></td>
						</tr>
	<?php endforeach; ?>
	<?php else: ?>
						<tr>
