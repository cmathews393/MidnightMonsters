...
<div id="servername">
<h1><?php print_r($ARK2Info ['HostName'])?></h1>
...
<div id="servertable">
				<table>
					...
					<tbody>
	<?php if( !empty( $ARK2Players ) ): ?>
	<?php foreach( $ARK2Players as $ARK2Player ): ?>
						<tr>
							<td><?php echo htmlspecialchars( $ARK2Player[ 'Name' ] ); ?></td>
							<td><?php echo $ARK2Player[ 'Frags' ]; ?></td>
							<td><?php echo $ARK2Player[ 'TimeF' ]; ?></td>
						</tr>
	<?php endforeach; ?>
	<?php else: ?>
						<tr>
