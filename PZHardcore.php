...
<div id="servername">
<h1><?php print_r($PZHardcoreInfo ['HostName'])?></h1>
...
<div id="servertable">
				<table>
					...
					<tbody>
	<?php if( !empty( $PZHardcorePlayers ) ): ?>
	<?php foreach( $PZHardcorePlayers as $PZHardcorePlayer ): ?>
						<tr>
							<td><?php echo htmlspecialchars( $PZHardcorePlayer[ 'Name' ] ); ?></td>
							<td><?php echo $PZHardcorePlayer[ 'Frags' ]; ?></td>
							<td><?php echo $PZHardcorePlayer[ 'TimeF' ]; ?></td>
						</tr>
	<?php endforeach; ?>
	<?php else: ?>
						<tr>
